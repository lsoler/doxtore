...
<body>
	...
	<div class="documentsListContainer">
		<ul data-bind="foreach: documents, visible: documents().length > 0"
			class="documentList">
			<li><span
				data-bind="css: { docIconWord : isDoc, docIconPdf : isPdf, docIconExcel : isExcel } "></span>
				<span data-bind="text: title"></span> <a href="#"
				data-bind="click: $root.openDocument">link</a></li>
		</ul>
	</div>

	<div data-bind="with: currentDocument">
		<h1 data-bind="text: title"></h1>
		<h2 data-bind="text: notes"></h2>
...
<button data-bind="click: save">Save</button>
  -->
	<form name="uploadForm" enctype="multipart/form-data">
		<input name="uploadInput" name="file" type="file" /> <input
			id="uploadBtn" type="button" value="Upload" />
	</form>
		...
		$('#uploadBtn').click(
				function() {
					...
					formData.append("File",
							document.uploadForm.uploadInput.files[0]);
